...
<body>
	...
	for ($i=0; $i<10; $i++) {//iterate from 0 to 9
		echo '<p>'.$lipsum.'</p>';//to concatenate strings in php use '.' instead of + 
	}
	?>
	...
	<hr>
        ...
        <form method="post" action="<?=$_SERVER['REQUEST_URI'];?>"><!--we read superglobal var $_POST in php script. Must use post method-->
	...
	<table>
		...
		<tbody>
			<?php foreach ($people as $person): ?><!--$person is an array. Not an object with public fields first_name,last_name,email-->
				<tr>
